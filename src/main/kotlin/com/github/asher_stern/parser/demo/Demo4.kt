...
fun main(args: Array<String>)
{
    ...
    val grammar = Grammar<String, String>(startSymbol, setOf("X1","X2","X3","X4"), setOf("x2", "x3"), setOf(rule1,rule2,rule3,rule4,rule5))
    val chomskyNormalFormGrammar = ChomskyNormalFormGrammarConstructor(grammar).construct()

    val sentence = Array1(arrayOf("x2", "x3"))

    val cykAlgorithm = CykAlgorithm(chomskyNormalFormGrammar, sentence)
